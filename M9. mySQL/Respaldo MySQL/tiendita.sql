...
INSERT INTO `categoria` VALUES (1,'Refrescos'),(2,'Aceites'),(3,'Detergentes'),(4,'Dulces'),(5,'Frituras'),(6,'trigger'),(7,'trigger'),(8,'trigger'),(9,'trigger'),(10,'trigger');
...
INSERT INTO `temp` VALUES (1,'Uno'),(2,'Dos'),(3,'trigger'),(4,'trigger'),(5,'trigger');
/*!40000 ALTER TABLE `temp` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary table structure for view `vista_productos_escaso`
--

DROP TABLE IF EXISTS `vista_productos_escaso`;
/*!50001 DROP VIEW IF EXISTS `vista_productos_escaso`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `vista_productos_escaso` AS SELECT 
 1 AS `idProducto`,
 1 AS `nombre`,
 1 AS `precio`,
 1 AS `fecha_alta`,
...
--
-- Final view structure for view `vista_productos_escaso`
--
...
/*!50001 VIEW `vista_productos_escaso` AS select `productos`.`idProducto` AS `idProducto`,`productos`.`nombre` AS `nombre`,`productos`.`precio` AS `precio`,`productos`.`fecha_alta` AS `fecha_alta`,`productos`.`idCategoria` AS `idCategoria`,`productos`.`existencia` AS `existencia` from `productos` where (`productos`.`existencia` < 10) */;
...
-- Dump completed on 2021-03-23 16:58:46
